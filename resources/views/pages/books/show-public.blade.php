    ...
    <body class="min-h-screen bg-gray-50 dark:bg-zinc-950">
        ...
        <main class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="no-print mb-8 flex items-center justify-between">
                ...
                <button onclick="printStory(event)"
                        class="hidden inline-flex items-center gap-1.5 rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-600 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
