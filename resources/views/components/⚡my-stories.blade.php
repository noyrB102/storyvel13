    ...
    <div class="flex min-h-[80vh] min-w-0 flex-col items-center justify-start px-4 pb-8 pt-10 text-center sm:px-6 md:hidden">
        <div class="mb-10 flex w-full max-w-sm items-start gap-3 text-center">
            ...
            <div class="flex-1">
                ...
                <p class="text-base text-gray-500 dark:text-gray-400">What would you like to do?</p>
            </div>
        </div>
        ...
        <div class="w-full max-w-sm flex flex-col gap-4">
            ...
            <a href="{{ route('ideas.index') }}" wire:navigate
               class="flex min-h-16 min-w-0 flex-wrap items-center justify-center gap-3 rounded-2xl bg-amber-400 px-5 py-6 text-center text-xl font-bold text-amber-950 shadow-lg active:bg-amber-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-7" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
