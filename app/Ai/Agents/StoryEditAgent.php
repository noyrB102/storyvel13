...
- Length: keep the finished story to approximately 350–450 words so it fits on a single printed page. If applying the change would push it longer, tighten elsewhere so the total stays within this range. Never let the story grow beyond one printed page.
PROMPT;
    }
}
