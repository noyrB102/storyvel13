        ...
        try {
            ...
            $formatInstructions = match ($this->story->format ?? 'explore') {
                'memoir'      => "You are writing a warm, true personal memoir based on the real details the author has provided. "
                    ...
                    . "5. Write approximately 350–450 words so the finished story fits on a single printed page. Complete prose — do not outline or ask questions.\n"
                    . "6. Start writing the memoir immediately — no preamble.\n\n",
                'short_story' => "Write a complete, self-contained short story of approximately 350–450 words so it fits on a single printed page. "
                ...
                'author_voice' => "You are a gentle editor and writing coach, NOT a ghostwriter. "
                    ...
                    . "8. Keep the polished story to approximately 350–450 words so it fits on a single printed page. If the author's draft is longer, tighten it gently without losing their voice or any real detail.\n"
